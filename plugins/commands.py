...
buttons=InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Source Code", url="https://github.com/mrinvisible7/forward_bot"),
                InlineKeyboardButton("Updates Channel", url="https://t.me/mr_invisible_bots")
            ]
        ]
        )
...
async def cb_abt(bot, cb):
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source", url="https://github.com/mrinvisible7/forward_bot"),
            ]
        ]
    )
    )
